...
// الرنة المزدوجة الهادئة لغرفة الانتظار
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between bg-[#0a101d] border border-[#162235] rounded-xl px-4 py-2.5 mb-5">
                    <div className="text-left overflow-hidden flex-1">
                      ...
                      <span className="font-mono text-cyan-400 text-sm font-black tracking-widest whitespace-nowrap block truncate">{t.plate}</span>
                    </div>
